...
elseif ($_REQUEST['act'] == 'info')
{
	...
	{
		//统计总营业额
		$sql="select sum(goods_amount) as number,order_id from " . $GLOBALS['ecs']->table('order_info') ." where order_status IN ('1','5') AND shipping_status IN ('1','2') AND pay_status IN ('2','1') and seller_id='".$comm_info['seller_id']."' and add_time>=".$comm_info['prev_date']." and add_time<=".gmtime();
